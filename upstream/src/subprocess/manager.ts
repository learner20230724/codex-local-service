...
export class CodexSubprocess {
  ...
  async start(options: CodexSubprocessOptions): Promise<InitializeResponse> {
    ...
    // Learning Demo: inference only; preserve official Codex authentication.
    const disabled = ["shell_tool", "unified_exec", "apply_patch_freeform", "apps",
      "plugins", "multi_agent", "collab", "code_mode", "js_repl", "browser_use",
